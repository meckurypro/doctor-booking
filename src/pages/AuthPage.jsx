  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col flex-1 pt-14">
        {/* Centered card — max-w-sm keeps the form readable on all screen sizes */}
        <div className="flex flex-col flex-1 w-full max-w-sm mx-auto px-6 py-12">
              ...
              <motion.div key="landing" {...fadeIn} className="flex flex-col flex-1">
                <div className="flex flex-col items-center mt-8 mb-12">
                  <div
                    ...
                    style={{ background: 'linear-gradient(135deg, #f97316, #ea580c)' }}
                  >
                    <img src="/icons/icon-96.png" alt="Meckury AI" className="w-14 h-14 object-contain" />
                  </div>
