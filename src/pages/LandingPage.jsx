...
// Matches README credit table exactly
const CREDIT_EXAMPLES = [
  ['Image generation',        '1 credit'],
  ['5-second video',          '2–3 credits'],
...
export default function LandingPage() {
  ...
  return (
    ...
    >
      {/* Background glow — placed at top level, not inside a section */}
      ...
      {/* ── Navbar ────────────────────────────────────────── */}
      <nav
        className="fixed top-0 left-0 right-0 z-50 px-6 h-14 flex items-center justify-between max-w-[480px] mx-auto"
      ...
      {/* ── Hero ──────────────────────────────────────────── */}
      <section className="relative z-10 px-6 pt-28 pb-16 text-center max-w-[480px] mx-auto">
        <FadeUp>
          <div
        ...
        <FadeUp delay={0.1}>
          <div className="flex flex-col gap-2">
            {EXAMPLES.map((ex) => (
              ...
              >
                <CheckCircle size={16} style={{ color: 'var(--brand)', flexShrink: 0 }} aria-hidden="true" />
      ...
      <section className="px-6 py-8 max-w-[480px] mx-auto">
            ...
            <FadeUp key={pkg.name} delay={i * 0.08}>
              ...
              >
                {pkg.featured && (
                  ...
                  >
                    <Star size={10} fill="white" aria-hidden="true" /> Best value
                  </div>
                )}
                <div>
        ...
        <FadeUp delay={0.3}>
          <div className="mt-4 flex flex-col gap-2">
            {CREDIT_EXAMPLES.map(([label, cost]) => (
              <div key={label} className="flex items-center gap-2">
                <Zap size={12} style={{ color: 'var(--brand)', flexShrink: 0 }} aria-hidden="true" />
      ...
      {/* ── Footer ────────────────────────────────────────── */}
      <footer
        className="px-6 py-6 text-center max-w-[480px] mx-auto"
      ...
      >
        ...
        <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
          © {new Date().getFullYear()} Meckury · AI Content Creation Platform
        </p>
        <p className="text-xs mt-1" style={{ color: 'var(--text-muted)' }}>
          A{' '}
          <a
